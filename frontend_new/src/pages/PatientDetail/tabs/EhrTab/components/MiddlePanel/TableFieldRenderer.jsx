...
const TableFieldRenderer = ({
  ...
  if (!field.tableData || field.tableData.length === 0) {
    return (
      <div style={{ textAlign: 'center', padding: 20, color: appThemeToken.colorTextTertiary, border: `1px dashed ${appThemeToken.colorBorder}`, borderRadius: 4 }}>
        <FileTextOutlined style={{ fontSize: 16, marginBottom: 8 }} />

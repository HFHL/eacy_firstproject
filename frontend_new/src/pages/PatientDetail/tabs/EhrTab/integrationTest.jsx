...
const EhrTabIntegrationTest = () => {
  ...
  const getEhrStatusIcon = (status) => {
    switch (status) {
      case 'completed':
        return <CheckCircleOutlined style={{ color: appThemeToken.colorSuccess, fontSize: 12 }} />
      case 'partial':
        return <ExclamationCircleOutlined style={{ color: appThemeToken.colorWarning, fontSize: 12 }} />
      case 'pending':
        return <ExclamationCircleOutlined style={{ color: appThemeToken.colorTextTertiary, fontSize: 12 }} />
      default:
        return null
    }
  }
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <Card title="EhrTab集成测试 - 布局切换功能" style={{ marginBottom: 16 }}>
        <div style={{ fontSize: 12, color: appThemeToken.colorTextSecondary }}>
      ...
      <EhrTab
        ...
        getEhrConfidenceColor={(confidence) => {
          switch (confidence) {
            ...
            default: return appThemeToken.colorTextTertiary
          }
        }}

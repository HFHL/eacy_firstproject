  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <Card title="MiddlePanel组件测试 - 新架构验证" style={{ marginBottom: 16 }}>
        ...
        <div style={{ marginTop: 12, fontSize: 12, color: appThemeToken.colorTextSecondary }}>
      ...
      {/* MiddlePanel组件测试 */}
      <div style={{ border: `2px dashed ${appThemeToken.colorPrimary}`, borderRadius: 8, padding: 16 }}>
        <div style={{ marginBottom: 12, fontSize: 14, fontWeight: 'bold', color: appThemeToken.colorPrimary }}>
          📦 MiddlePanel组件 (新架构)
        </div>
        <MiddlePanel
